...
(function (global, factory) {
  ...
  function _asyncGeneratorDelegate (t) {
    ...
    }, typeof t.throw === 'function' && (e.throw = function (t) {
      if (n) throw n = !1, t;
      return pump('throw', t);
    }), typeof t.return === 'function' && (e.return = function (t) {
  ...
  function _regeneratorRuntime () {
    ...
    const o = Object.defineProperty || function (t, e, r) {
      t[e] = r.value;
    };
    ...
    const g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p);
    ...
    function makeInvokeMethod (e, r, n) {
      ...
      return function (i, a) {
        ...
        for (n.method = i, n.arg = a; ;) {
          ...
          p.type === 'throw' && (o = s, n.method = 'throw', n.arg = p.arg);
        }
      };
    }
    function maybeInvokeDelegate (e, r) {
      ...
      if (o === t) return r.delegate = null, n === 'throw' && e.iterator.return && (r.method = 'return', r.arg = t, maybeInvokeDelegate(e, r), r.method === 'throw') || n !== 'return' && (r.method = 'throw', r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y;
      const i = tryCatch(o, e.iterator, r.arg);
      if (i.type === 'throw') return r.method = 'throw', r.arg = i.arg, r.delegate = null, y;
      const a = i.arg;
      return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, r.method !== 'return' && (r.method = 'next', r.arg = t), r.delegate = null, y) : a : (r.method = 'throw', r.arg = new TypeError('iterator result is not an object'), r.delegate = null, y);
    }
    ...
    return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, 'constructor', {
      ...
      constructor: Context,
      reset: function (e) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = 'next', this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (const r in this) r.charAt(0) === 't' && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t);
      },
      stop: function () {
        this.done = !0;
      ...
      complete: function (t, e) {
        if (t.type === 'throw') throw t.arg;
        return t.type === 'break' || t.type === 'continue' ? this.next = t.arg : t.type === 'return' ? (this.rval = this.arg = t.arg, this.method = 'return', this.next = 'end') : t.type === 'normal' && e && (this.next = e), y;
      },
      finish: function (t) {
  ...
  const generateString = function generateString () {
    ...
    const alphabet = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ALPHABET.ALPHA_DIGIT;
    let str = '';
   ...
   * @returns {boolean}
   */
  const hasStandardBrowserEnv = (function (product) {
  ...
  const AxiosHeaders = /* #__PURE__ */(function (_Symbol$iterator, _Symbol$toStringTag) {
  ...
  const xhrAdapter = isXHRAdapterSupported && function (config) {
    return new Promise(function dispatchXhrRequest (resolve, reject) {
      ...
      if (onDownloadProgress) {
        const _progressEventReducer = progressEventReducer(onDownloadProgress, true);
        const _progressEventReducer2 = _slicedToArray(_progressEventReducer, 2);
      ...
      if (onUploadProgress && request.upload) {
        ...
        const _progressEventReducer4 = _slicedToArray(_progressEventReducer3, 2);
  ...
  const composeSignals = function composeSignals (signals, timeout) {
    ...
    let aborted;
    const onabort = function onabort (cancel) {
      if (!aborted) {
        aborted = true;
        unsubscribe();
  ...
  const streamChunk = /* #__PURE__ */_regeneratorRuntime().mark(function streamChunk (chunk, chunkSize) {
    let len, pos, end;
  ...
  const readBytes = /* #__PURE__ */(function () {
    const _ref = _wrapAsyncGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee (iterable, chunkSize, encode) {
      let _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, chunk;
  ...
  const trackStream = function trackStream (stream, chunkSize, onProgress, onFinish, encode) {
    ...
    return new ReadableStream({
      pull: function pull (controller) {
        return _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee2 () {
          let _yield$iterator$next, _done, value, len, loadedBytes;
  ...
  const encodeText = isFetchSupported && (typeof TextEncoder === 'function' ? (function (encoder) {
    ...
    const _ref = _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee (str) {
  ...
  isFetchSupported && (function (res) {
    ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach(function (type) {
      !resolvers[type] && (resolvers[type] = utils$1.isFunction(res[type])
        ? function (res) {
          return res[type]();
        }
        : function (_, config) {
  ...
  const getBodyLength = /* #__PURE__ */(function () {
    const _ref2 = _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee2 (body) {
  ...
  const resolveBodyLength = /* #__PURE__ */(function () {
    const _ref3 = _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee3 (headers, body) {
      let length;
  ...
  const fetchAdapter = isFetchSupported && (/* #__PURE__ */function () {
    const _ref4 = _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee4 (config) {
      let _resolveConfig, url, method, data, signal, cancelToken, timeout, onDownloadProgress, onUploadProgress, responseType, headers, _resolveConfig$withCr, withCredentials, fetchOptions, _ref5, _ref6, composedSignal, stopTimeout, finished, request, onFinish, requestContentLength, _request, contentTypeHeader, _progressEventDecorat, _progressEventDecorat2, onProgress, flush, response, isStreamResponse, options, responseContentLength, _ref7, _ref8, _onProgress, _flush, responseData;
  ...
  const Axios = /* #__PURE__ */(function () {
    ...
    _createClass(Axios, [{
      key: 'request',
      value: (function () {
        const _request2 = _asyncToGenerator(/* #__PURE__ */_regeneratorRuntime().mark(function _callee (configOrUrl, config) {
          let dummy, stack;
          return _regeneratorRuntime().wrap(function _callee$ (_context) {
            while (1) {
              switch (_context.prev = _context.next) {
